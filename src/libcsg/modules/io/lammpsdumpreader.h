...
class LAMMPSDumpReader : public TrajectoryReader, public TopologyReader {
 ...
 private:
  void ReadTimestep(CSG_Topology &top, std::string itemline);
  void ReadBox(CSG_Topology &top, std::string itemline);
  void ReadNumAtoms(CSG_Topology &top, std::string itemline);
