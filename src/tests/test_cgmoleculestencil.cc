...
BOOST_AUTO_TEST_CASE(test_load) {
  ...
  cout << "Testing getCGBeadName" << endl;
  {
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:C1"), "A1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H4"), "A1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H5"), "A1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H6"), "A1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:C2"), "B1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H7"), "B1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H8"), "B1");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:C3"), "A2");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H9"), "A2");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H10"), "A2");
    BOOST_CHECK_EQUAL(molecule_stencil.getCGBeadName("1:ppn:H11"), "A2");
  }
}
