...
function(_GROMACS_GET_VERSION _OUT_ver _version_hdr)
  ...
  message("VERSION header file")
  message(${_version_hdr})
...
pkg_check_modules(PC_GROMACS_MPI libgromacs_mpi)

message("LIBRARY DIRS")
message(STATUS ${PC_GROMACS_D_LIBRARY_DIRS})
message(STATUS ${PC_GROMACS_LIBRARY_DIRS})
message(STATUS ${PC_GROMACS_MPI_LIBRARY_DIRS})
find_library(GROMACS_LIBRARY NAMES gromacs_d gromacs gromacs_mpi HINTS ${PC_GROMACS_D_LIBRARY_DIRS} ${PC_GROMACS_LIBRARY_DIRS} ${PC_GROMACS_MPI_LIBRARY_DIRS})

message("GROMACS LIBRARY is")
message(${GROMACS_LIBRARY})
...
message("PC variable")
message(${PC_GROMACS_MPI_INCLUDE_DIRS})
find_path(GROMACS_INCLUDE_DIR gromacs/version.h HINTS ${PC_GROMACS_D_INCLUDE_DIRS} ${PC_GROMACS_INCLUDE_DIRS} ${PC_GROMACS_MPI_INCLUDE_DIRS})
message("GROMACS version in include dir")
message(${GROMACS_INCLUDE_DIR})
#message(STATUS ${GROMACS_VERSION})
...
elseif(GROMACS_INCLUDE_DIR)
  ...
  elseif(EXISTS "${GROMACS_INCLUDE_DIR}/gmxapi/version.h")
    _GROMACS_GET_VERSION(GROMACS_VERSION ${GROMACS_INCLUDE_DIR}/gmxapi/version.h)
  endif()
else()
